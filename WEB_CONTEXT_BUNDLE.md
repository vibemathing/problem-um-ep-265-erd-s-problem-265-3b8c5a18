...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-ep-265-erd-s-problem-265-3b8c5a18-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/EP-265"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-ep-265-erd-s-problem-265-3b8c5a18-v1",
      "problem_contract_sha256": "0e4b77ca7a3040c9be1bb5e5a46b3219cfb29a2faaeca73c7bf606427e037b61",
      "problem_id": "problem:um-ep-265-erd-s-problem-265-3b8c5a18",
      "route_id": "route:um-ep-265-erd-s-problem-265-3b8c5a18-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-ep-265-erd-s-problem-265-3b8c5a18-source-fidelity-01",
      "graph_id": "graph:um-ep-265-erd-s-problem-265-3b8c5a18-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-ep-265-erd-s-problem-265-3b8c5a18-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-ep-265-erd-s-problem-265-3b8c5a18-root",
          "statement": {
          ...
          "statement_sha256": "d9eeebaeed6782327cfa0ad9f78db47cb506edcbbcced062e0c7d5ef228194e0"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-ep-265-erd-s-problem-265-3b8c5a18-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-ep-265-erd-s-problem-265-3b8c5a18-root",
      "route_id": "route:um-ep-265-erd-s-problem-265-3b8c5a18-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-ep-265-8b48a84be1a8",
        "url": "https://www.unsolvedmath.com/problems/EP-265"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
